      ...
      <div className='min-h-screen flex items-center justify-center bg-gray-50 px-4'>
        ...
        >
          ...
          <p className='text-gray-600 mb-4'>
            Welcome to Hirely! You have successfully joined.
          </p>
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className='flex items-center space-x-4'>
              ...
              <div className='flex-1'>
                ...
                <p className='font-semibold text-xs text-gray-500 mt-1'>JPG, PNG up to 5MB </p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className='grid grid-cols-2 gap-4 mt-5'>
              <button
                ...
                className={`p-4 rounded-lg border-2 transition-all ${formData.role === 'jobseeker' ? "border-blue-500 bg-blue-100" : "border-gray-200 hover:border-gray-300"}`}
              >
              ...
              <button
                ...
                className={`p-4 rounded-lg border-2 transition-all ${formData.role === 'employer' ? "border-blue-500 bg-blue-100" : "border-gray-200 hover:border-gray-300"}`}
              >
          ...
          <button
            ...
            className='mt-5 w-full bg-linear-to-r from-blue-600 to-purple-600 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2'
          >
            {formState.loading ? (
              <>
