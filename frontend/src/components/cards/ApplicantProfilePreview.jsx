                ...
                <div className='p-6'>
                    ...
                    <div className='space-y-4'>
                        ...
                        <div className='mt-4'>
                            ...
                            <select value={currentStatus} onChange={onChangeStatus} disabled={loading} className='w-full border border-gray-300 rounded-lg p-2 focus:ring-blue-500 focus:border-blue-500'>
